...
rivers = st_read("partsection_riverpoints/MinervaRiv.shp")
...
pdf(file = "results/partsection_wo_constraint2.pdf",onefile = TRUE,paper = "a4")
for(i in 1:n_rivers)
{
  print(L[[i]][[12]])
}
...
save(RES,L,table_points,comp_points,file = "results/partsection_wo_constraint.Rdata")
write.table(x = RES,file = "results/partsection_wo_constraint.csv",sep = ";")
...
# saving the results
save(tab_indic,file = "results/Indic_partsection_wo_constraint.Rdata")
