...
rm(elevation,ras,rivers,i,n,pos,res,my.lm,res_p,seg.lm1,seg.lm2,tab,distance,res_low,res_up,aude)
...
pdf(file = "results/fullsection_wo_constraint.pdf",onefile = TRUE,paper = "a4")
for(i in 1:n_rivers)
{
  print(L[[i]][[12]])
}
...
save(RES,L,table_points,comp_points,conf_points,file = "results/fullsection_wo_constraint.Rdata")
write.table(x = RES,file = "results/fullsection_wo_constraint.csv",sep = ";")
...
# saving the results
save(tab_indic,file = "results/Indic_fullsection_wo_constraint.Rdata")
